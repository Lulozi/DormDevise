...
import 'package:dormdevise/views/splash/splash_wrapper.dart';
...
Future<void> main() async {
  await runZonedGuarded<Future<void>>(
    () async {
      ...
      // Use an in-app splash wrapper to guarantee a minimum visible time
      // for the launch splash across all platforms. Native splash drawables
      // generated by flutter_native_splash provide the initial launch
      // image; SplashWrapper ensures the combined visible time is at least
      // 1s.
      runApp(
        SplashWrapper(startupBegin: startupBegin, child: const DormDeviseApp()),
      );
    },
